...
if __name__ == '__main__':
    ...
    pytest.main(["-vs", path_account,'--clean-alluredir', '--alluredir=Report/' + report_file])
    pytest.main(["-vs", path_transfer,'--clean-alluredir', '--alluredir=Report/' + report_file])
    pytest.main(["-vs", path_stake,'--clean-alluredir', '--alluredir=Report/' + report_file])
