...
class Test_transfers_success:
    if env_type == 0: #测试
        test_data = [
            ...
            ("BTC Custodial账户转账 fee<minfee","BTC","BTC","tb1q5qe4xx0uc300fdqq5xe5mj6ku7x3m0y7epehkn","tb1qqrw8uz4j305w6fjr4mwng040sv7kz8hcczjfun","0.00009999",400,2102004),

            # GOERLI
            ("GOERLI Custodial账户转账 nativecoin 手续费不留","GOERLI","GoerliETH","0x57d8daBDF8C9eD5D9FF512F1033576303Ff9Aa20","0xbdb3bd7b3f3daeadc58d00ef5f15ed9a476b8fe3","0.001",400,2100000),
            ("GOERLI Custodial账户转账 nativecoin 手续费留1wei","GOERLI","GoerliETH","0x57d8daBDF8C9eD5D9FF512F1033576303Ff9Aa20","0xbdb3bd7b3f3daeadc58d00ef5f15ed9a476b8fe3","0.000999999999",400,2100000),
    ...
    @allure.story("Custodial Transfers Fail Feepoor!")
