...
class Test_swap_success:
    if env_type == 0: #测试
        test_data = [
            # MATIC网络
            ("正常SWAP(MATIC-USDC)",["dca5feaaf2296dca296a015b0ce26d82f89ab8d0f77ec98901a77e96f6e2e2da"],"MATIC","MATIC","USDC","0xe525E7cd17f6Dc950492755A089E452fd5d9d44f","1",str(Conf.Config.random_amount(4))),
            # ("正常SWAP(USDC-MATIC)",["dca5feaaf2296dca296a015b0ce26d82f89ab8d0f77ec98901a77e96f6e2e2da"],"MATIC","USDC","MATIC","0xe525E7cd17f6Dc950492755A089E452fd5d9d44f","1",str(Conf.Config.random_amount(4))),
            # ("正常SWAP(USDC-USDT)",["dca5feaaf2296dca296a015b0ce26d82f89ab8d0f77ec98901a77e96f6e2e2da"],"MATIC","USDC","USDT","0xe525E7cd17f6Dc950492755A089E452fd5d9d44f","1",str(Conf.Config.random_amount(4))),
        ]
    if env_type == 1: #生产
        test_data = [
            # BSC网络
