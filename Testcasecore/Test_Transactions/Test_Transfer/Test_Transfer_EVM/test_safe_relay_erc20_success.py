...
class Test_transfer_success:
    ...
    @pytest.mark.parametrize('test_title,privatekey,publickey,networkCode,tokenaddress,privatekey_relay,publickey_relay,relayaddress,fromaddress,toaddress,value', test_data)
    def test_custodial(self,test_title,privatekey,publickey,networkCode,tokenaddress,privatekey_relay,publickey_relay,relayaddress,fromaddress,toaddress,value):
