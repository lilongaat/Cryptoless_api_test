...
class Test_stake_fail:
    if env_type == 0: #测试
        test_data = [
            # IRIS网络
            # ("Custodial账户质押networkcode为空","","IRIS","stake","iaa1vywcfmff44nlhud05nlzlpw0hrlxenptn9ff7r",str(Conf.Config.random_amount(5)),400,2100000),
            # ("Custodial账户质押networkcode不存在","IRISS","IRIS","stake","iaa1vywcfmff44nlhud05nlzlpw0hrlxenptn9ff7r",str(Conf.Config.random_amount(5)),404,2200000),
            # ("Custodial账户质押networkcode不支持","ETH","ETH","stake","0x821647aF7f50717500E008dE239f8692216cBC67",str(Conf.Config.random_amount(5)),400,2200000),
            # ("Custodial账户质押symbol为空","IRIS","","stake","iaa1vywcfmff44nlhud05nlzlpw0hrlxenptn9ff7r",str(Conf.Config.random_amount(5)),400,2200000),
            # ("Custodial账户质押symbol不存在","IRIS","IIRS","stake","iaa1vywcfmff44nlhud05nlzlpw0hrlxenptn9ff7r",str(Conf.Config.random_amount(5)),400,2200000),
            # ("Custodial账户质押地址为空","IRIS","IRIS","stake","",str(Conf.Config.random_amount(5)),404,2200000),
            # ("Custodial账户质押地址非该用户","IRIS","IRIS","stake","iva1543nj4z07vjqztvu3358fr2z2hcp0qtmceank5",str(Conf.Config.random_amount(5)),404,2200000),
            # ("Custodial账户质押地址非该网络","IRIS","IRIS","stake","5CFStFse5QY5dyfeHeTDSnMeBBRgxXse2D8k1TUbM67HeA9h",str(Conf.Config.random_amount(5)),404,2200000),
            # ("Custodial账户质押金额为空","IRIS","IRIS","stake","iaa1vywcfmff44nlhud05nlzlpw0hrlxenptn9ff7r","",400,2300000),
            # ("Custodial账户质押金额大于余额","IRIS","IRIS","stake","iaa1vywcfmff44nlhud05nlzlpw0hrlxenptn9ff7r","100000",400,2102001),
            # ("Custodial账户质押金额超出精度","IRIS","IRIS","stake","iaa1vywcfmff44nlhud05nlzlpw0hrlxenptn9ff7r",str(Conf.Config.random_amount(19)),400,2100000),
            ("Custodial账户质押手续费不足","IRIS","IRIS","stake","iaa180qh39f68devetnda4t28drsrhgxnjha5eqhus","0.000001",400,2102001),
