...
class Test_holders_check:
    ...
    test_data = [
        {
            'Authorization': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIxNTc1MzExMDYxOTQ1ODg4NzcwIiwiZXhwIjoxNjY5NjkzMTMwLCJpYXQiOjE2NjkwODgzMzAsInVzZXJJZCI6MTU3NTMxMTA2MTk0NTg4ODc3MH0.eBJ_MQk6HSk-jILqlJp9K8uiNEdNnh9g01180Myq7g4',
        }
    ]
