...
class Test_transfers_success:
    if env_type == 0: #测试
        test_data = [
            # GOERLI
            ("GOERLI 多签账户转账 nativecoin","GOERLI","GoerliETH",["dca5feaaf2296dca296a015b0ce26d82f89ab8d0f77ec98901a77e96f6e2e2da","0fbde0fc6a050c10f98ea3fd2921d2b52780667eed2871a132b60c7aab3ff51d"],"0xa28cf89352bd298a397216b3d77fd9a7b5bffb71","0xa7A9E710f9A3B4184D4F8B7d379CEC262f2382c2","0.00012",1,"9cbca176aff8c48ebd9a27c31455e34ebc86e25a17e22b3d65a716fc851ada38","0326288a7bbff5dc672bfec0a0a02ccae3eeb3e93a0294c8e0f534c97438de0fce"),
            # ("GOERLI 多签账户转账 erc20coin","GOERLI","USDCC",["dca5feaaf2296dca296a015b0ce26d82f89ab8d0f77ec98901a77e96f6e2e2da","0fbde0fc6a050c10f98ea3fd2921d2b52780667eed2871a132b60c7aab3ff51d"],"0xa28cf89352bd298a397216b3d77fd9a7b5bffb71","0xa7A9E710f9A3B4184D4F8B7d379CEC262f2382c2","1.201",1,"9cbca176aff8c48ebd9a27c31455e34ebc86e25a17e22b3d65a716fc851ada38","0326288a7bbff5dc672bfec0a0a02ccae3eeb3e93a0294c8e0f534c97438de0fce"),
        ]
    elif env_type == 1: #生产
        test_data = []
    ...
    @pytest.mark.parametrize('test_title,networkCode,symbol,privatekey,from_add,to_add,amount,paytype,senderPrivatekey,senderPublicKey', test_data)
    def test_custodial(self,test_title,networkCode,symbol,privatekey,from_add,to_add,amount,paytype,senderPrivatekey,senderPublicKey):
