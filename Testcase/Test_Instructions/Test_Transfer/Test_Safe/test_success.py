...
class Test_transfers_success:
    if env_type == 0: #测试
        test_data = [
            ...
            # ("Safe2-2账户ERC20转账",["dca5feaaf2296dca296a015b0ce26d82f89ab8d0f77ec98901a77e96f6e2e2da"],"GOERLI","Long","0xD79CF3C3FdAaC5F7114e5Dc67376E86206cc313D","0x2B0EfCF16EC1E4C5eD82dBB4Fce9B4811485e650",str(round(random.uniform(1,10), random.randint(1,18)))),
            ...
            # ("Safe2-3账户ERC20转账",["dca5feaaf2296dca296a015b0ce26d82f89ab8d0f77ec98901a77e96f6e2e2da"],"GOERLI","Long","0x81B806cf821c5C298Bef4261602bf636F72Bf620","0x2B0EfCF16EC1E4C5eD82dBB4Fce9B4811485e650",str(round(random.uniform(1,10), random.randint(1,18)))),
            # MATIC网络
            ("MATIC Safe2-2账户MATIC转账",["dca5feaaf2296dca296a015b0ce26d82f89ab8d0f77ec98901a77e96f6e2e2da"],"MATIC","MATIC","0x42aD4f9111c14C1beE0c142EF275Ee08AA7B1E5e","0xDBA67bAa3CA1e89a2BDf0fEeE4592595b130888A",str(Conf.Config.random_amount(7))),
            # ("MATIC Safe2-2账户ERC20转账",["dca5feaaf2296dca296a015b0ce26d82f89ab8d0f77ec98901a77e96f6e2e2da"],"MATIC","USDC","0x42aD4f9111c14C1beE0c142EF275Ee08AA7B1E5e","0xDBA67bAa3CA1e89a2BDf0fEeE4592595b130888A",str(Conf.Config.random_amount(5))),
            # ("MATIC Safe2-3账户MATIC转账",["dca5feaaf2296dca296a015b0ce26d82f89ab8d0f77ec98901a77e96f6e2e2da"],"MATIC","MATIC","0x1037477a2e863DA6f242ee06E106E8116857bF6E","0xDBA67bAa3CA1e89a2BDf0fEeE4592595b130888A",str(Conf.Config.random_amount(7))),
            # ("MATIC Safe2-3账户ERC20转账",["dca5feaaf2296dca296a015b0ce26d82f89ab8d0f77ec98901a77e96f6e2e2da"],"MATIC","USDC","0x1037477a2e863DA6f242ee06E106E8116857bF6E","0xDBA67bAa3CA1e89a2BDf0fEeE4592595b130888A",str(Conf.Config.random_amount(5))),
            # BSC网络
            # ("BSC Safe2-2账户BNB转账",["dca5feaaf2296dca296a015b0ce26d82f89ab8d0f77ec98901a77e96f6e2e2da"],"BSC","BNB","0xfe8271fFEceA7327f00d3a416A48a471a19cFa32","0xDBA67bAa3CA1e89a2BDf0fEeE4592595b130888A",str(Conf.Config.random_amount(7))),
            # ("BSC Safe2-2账户USDC转账",["dca5feaaf2296dca296a015b0ce26d82f89ab8d0f77ec98901a77e96f6e2e2da"],"BSC","USDC","0xfe8271fFEceA7327f00d3a416A48a471a19cFa32","0xDBA67bAa3CA1e89a2BDf0fEeE4592595b130888A",str(Conf.Config.random_amount(7))),
            # IRIS
            ...
            # CLV
            # ("Safe账户CLV转账",["7967c43bd3f3874ccfa6ff6ceda5faa8c699ad0fe2be33f44c8bb8abcb23a2fd"],"CLV","CLV","5Hdmv7BeAe1XFJXso8oGMidGp186cb4uNTNMywp6fBY7UEsr","5HWsR2E9YLKqfz6ybMufU5t1qyjUMzmBwFjppsaEwZHegViT",str(Conf.Config.random_amount(5))),
        ]
    elif env_type == 1: #生产
        test_data = [
            # # DOGE网络
