...
class Test_transfers_success:
    if env_type == 0: #测试
        test_data = [
            ...
            # CLV
            ("External账户IRIS转账",["7967c43bd3f3874ccfa6ff6ceda5faa8c699ad0fe2be33f44c8bb8abcb23a2fd"],"CLV","CLV","5Hdmv7BeAe1XFJXso8oGMidGp186cb4uNTNMywp6fBY7UEsr","5HWsR2E9YLKqfz6ybMufU5t1qyjUMzmBwFjppsaEwZHegViT",str(Conf.Config.random_amount(5))),
        ]
    elif env_type == 1: #生产
        test_data = [
            # DOGE网络
