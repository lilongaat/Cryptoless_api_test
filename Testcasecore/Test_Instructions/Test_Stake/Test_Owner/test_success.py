...
class Test_transfers_success:
    if env_type == 0: #测试
        test_data = [
            #IRIS
            # ("IRIS 质押","IRIS","IRIS","stake","d10003ebe2876bd53bf2bb2200eb873a089520a3395b63a4f04330c00e9a885b","iaa1ed68xf6453t7u4ttsmphdrwqflx2l90e6ymuaq","0.00123"),
            # ("IRIS 解除质押","IRIS","IRIS","un_stake","d10003ebe2876bd53bf2bb2200eb873a089520a3395b63a4f04330c00e9a885b","iaa1ed68xf6453t7u4ttsmphdrwqflx2l90e6ymuaq","0.0012"),
            # ("IRIS 提取奖励","IRIS","IRIS","claim","d10003ebe2876bd53bf2bb2200eb873a089520a3395b63a4f04330c00e9a885b","iaa1ed68xf6453t7u4ttsmphdrwqflx2l90e6ymuaq",""),

            #CLV
            ("CLV 质押","CLV","CLV","stake","7967c43bd3f3874ccfa6ff6ceda5faa8c699ad0fe2be33f44c8bb8abcb23a2fd","5Hdmv7BeAe1XFJXso8oGMidGp186cb4uNTNMywp6fBY7UEsr","0.00123"),
            # ("CLV 解除质押","CLV","CLV","un_stake","7967c43bd3f3874ccfa6ff6ceda5faa8c699ad0fe2be33f44c8bb8abcb23a2fd","5Hdmv7BeAe1XFJXso8oGMidGp186cb4uNTNMywp6fBY7UEsr","0.00123"),
            # ("CLV 提取奖励","CLV","CLV","claim","7967c43bd3f3874ccfa6ff6ceda5faa8c699ad0fe2be33f44c8bb8abcb23a2fd","5Hdmv7BeAe1XFJXso8oGMidGp186cb4uNTNMywp6fBY7UEsr",""),
        ]
    elif env_type == 1: #生产
        test_data = []
