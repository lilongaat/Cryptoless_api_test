...
class Test_swap_success_matic_safe_pub:
    test_data = [
        # 测试
        ("USDT->USDC(PublicKeys不传)[]!",["ae0f28a2d98211ea6f656ecffa8a821235f78354921d63346c6be48a52610187"],[],"MATIC","USDT","USDC","swap","0x108e67cF13Bbd1e346B6282bA169E3e49f49a1B5","10",'0.001'),
        ("USDT->USDC(PublicKeys不传)[]!",["ae0f28a2d98211ea6f656ecffa8a821235f78354921d63346c6be48a52610187"],[],"MATIC","USDT","USDC","swap","0x108e67cF13Bbd1e346B6282bA169E3e49f49a1B5","10",'0.001'),
        ("USDC->USDT(PublicKeys传一个)[k1(托管)]!",["ae0f28a2d98211ea6f656ecffa8a821235f78354921d63346c6be48a52610187"],["03f1b7e94f4c83b3c1505cc15e4a14e172323afe0b946295eece18300da6ec2228"],"MATIC","USDC","USDT","swap","0x108e67cF13Bbd1e346B6282bA169E3e49f49a1B5","10",'0.001'),
        ("USDC->USDT(PublicKeys传两个)[k1(托管),k2(私有)]!",["ae0f28a2d98211ea6f656ecffa8a821235f78354921d63346c6be48a52610187"],["03f1b7e94f4c83b3c1505cc15e4a14e172323afe0b946295eece18300da6ec2228","0331e3ab5059c28098131d50856a99fcf40bea39b61f08ea55e1f35fbed131d2c0"],"MATIC","USDC","USDT","swap","0x108e67cF13Bbd1e346B6282bA169E3e49f49a1B5","10",'0.001'),
        ]
    # test_data = [
    #     # 测试
    #     ("USDT->USDC(PublicKeys不传)[]!",["ae0f28a2d98211ea6f656ecffa8a821235f78354921d63346c6be48a52610187"],[],"MATIC","USDT","USDC","swap","0x108e67cF13Bbd1e346B6282bA169E3e49f49a1B5","1",round(random.uniform(0.0001,0.001), random.randint(4,6))),
    #     # ("USDC->USDT(PublicKeys传一个)[k1(托管)]!",["ae0f28a2d98211ea6f656ecffa8a821235f78354921d63346c6be48a52610187"],["03f1b7e94f4c83b3c1505cc15e4a14e172323afe0b946295eece18300da6ec2228"],"MATIC","USDT","USDC","swap","0x108e67cF13Bbd1e346B6282bA169E3e49f49a1B5","1",round(random.uniform(0.0001,0.001), random.randint(4,6))),
    #     # ("USDC->USDT(PublicKeys传两个)[k1(托管),k2(私有)]!",["ae0f28a2d98211ea6f656ecffa8a821235f78354921d63346c6be48a52610187"],["03f1b7e94f4c83b3c1505cc15e4a14e172323afe0b946295eece18300da6ec2228","0331e3ab5059c28098131d50856a99fcf40bea39b61f08ea55e1f35fbed131d2c0"],"MATIC","USDT","USDC","swap","0x108e67cF13Bbd1e346B6282bA169E3e49f49a1B5","1",round(random.uniform(0.0001,0.001), random.randint(4,6))),
    #     ]

    @allure.story("Swap_MATIC_Success!")
    @allure.title('多签账户(2-3)Swap-{test_title}')
