...
class HttpUtils:
    ...
    @staticmethod
    #  instructions (type: Transfer/CrossChainTransfer/SwapTransfer)
    def instructions(type: str,body: list, networkCode: str, definiteSignerPublicKeys: list, transactionParams = '', Authorization=Authorization_):
        url = "http://18.163.229.203:8888/escrow/api/instructions"
        headers = {
            "Content-Type": "application/json",
            "Authorization": Authorization
        }
    ...
    @staticmethod
    # sign
    def sign(id: str, signatures: list, serialized: str, Authorization=Authorization_):
        url = "http://18.163.229.203:8888/escrow/api/transactions/" + id + "/signatures"
        headers = {
            "Content-Type": "application/json",
            "Authorization": Authorization
        }
    ...
    @staticmethod
    # 查询交易
    def get_transactions(address: str, expand = 'transactions', Authorization=Authorization_):
