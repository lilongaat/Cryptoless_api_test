...
class Test_stake_success:
    test_data = [
        ...
        # CLV网络
        ("Custodial账户IRIS质押","CLV","CLV","stake","5DiDtDkGFJ4CtgdEnGHaWU3JwSmCro26FozcqyTY8Brk3KSo",str(Conf.Config.random_amount(4))),
        # ("Custodial账户IRIS赎回","CLV","CLV","unstake","5DiDtDkGFJ4CtgdEnGHaWU3JwSmCro26FozcqyTY8Brk3KSo",str(Conf.Config.random_amount(5))),
        # ("Custodial账户IRISclaim","CLV","CLV","claim","5DiDtDkGFJ4CtgdEnGHaWU3JwSmCro26FozcqyTY8Brk3KSo",0),
    ]
