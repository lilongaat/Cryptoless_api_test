...
class Test_transfers_success_eth_safe:
    test_data = [
        ...
        # ("正常转账maximum!",["ae0f28a2d98211ea6f656ecffa8a821235f78354921d63346c6be48a52610187"],["0331e3ab5059c28098131d50856a99fcf40bea39b61f08ea55e1f35fbed131d2c0","03f1b7e94f4c83b3c1505cc15e4a14e172323afe0b946295eece18300da6ec2228"],"ETH-RINKEBY","ETH","0xF0d689E18d2f000663e507A39dCfA1DdC26a8Dc3","0x6146ca4fc34aaA7a6f9D0417a9A4f10e41b6a7Be","maximum"),
    ]
    ...
    def test_transfers_address_safe(self,test_title,privatekey,PublicKeys,networkCode,symbol,from_add,to_add,amount):
        ...
        signature_me = Conf.Config.sign(privatekey[0],res[5][0]['hash'])
        signatures = []
        signatures = [
            {
                "hash":res[5][0]['hash'],
        ...
        with allure.step("请求签名交易——req_sign"):
            requiredSignings = [{
                "message":sig.json()["requiredSignings"][0]["hash"],
        ...
        with allure.step("托管key签名——confirm-sign"):
        ...
        with allure.step("签名交易——sign"):
            ...
            sig = Http.HttpUtils.post_sign_transfers(res[1],res[2],res[3],res[4],res[5],res[6],signatures_key)
            assert sig.status_code == 200
